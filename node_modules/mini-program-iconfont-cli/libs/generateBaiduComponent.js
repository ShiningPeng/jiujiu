...
exports.generateBaiduComponent = function (data, config) {
    var svgTemplates = [];
    var names = [];
    ...
    fs_1.default.writeFileSync(path_1.default.join(saveDir, fileName + '.css'), getTemplate_1.getTemplate('baidu.css'));
    fs_1.default.writeFileSync(path_1.default.join(saveDir, fileName + '.swan'), svgTemplates.join('\n\n'));
    var jsFile = getTemplate_1.getTemplate('baidu.js');
    ...
    fs_1.default.writeFileSync(path_1.default.join(saveDir, fileName + '.json'), getTemplate_1.getTemplate('baidu.json'));
