...
exports.generateToutiaoComponent = function (data, config) {
    var svgTemplates = [];
    var names = [];
    ...
    fs_1.default.writeFileSync(path_1.default.join(saveDir, fileName + '.ttss'), getTemplate_1.getTemplate('toutiao.ttss'));
    fs_1.default.writeFileSync(path_1.default.join(saveDir, fileName + '.ttml'), svgTemplates.join('\n\n'));
    var jsFile = getTemplate_1.getTemplate('toutiao.js');
    ...
    fs_1.default.writeFileSync(path_1.default.join(saveDir, fileName + '.json'), getTemplate_1.getTemplate('toutiao.json'));
