...
exports.generateWechatComponent = function (data, config) {
    var svgTemplates = [];
    var names = [];
    ...
    fs_1.default.writeFileSync(path_1.default.join(saveDir, fileName + '.wxss'), getTemplate_1.getTemplate('wechat.wxss'));
    fs_1.default.writeFileSync(path_1.default.join(saveDir, fileName + '.wxml'), svgTemplates.join('\n\n'));
    var jsFile = getTemplate_1.getTemplate('wechat.js');
    ...
    fs_1.default.writeFileSync(path_1.default.join(saveDir, fileName + '.json'), getTemplate_1.getTemplate('wechat.json'));
        ...
        try {
            for (var _b = tslib_1.__values(Object.keys(sub.$)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                if (attributeName === 'fill') {
                    var color = replace_1.replaceHexToRgb(sub.$[attributeName]);
